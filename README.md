...
4.  In <tt>CreationApplication</tt>, the following code give the remote actor the same name as the router (<tt>advancedCalculator</tt>):
...
I thought that <tt>CreationApplication</tt> or <tt>LookupApplication</tt> might launch <tt>CalculatorApplication</tt>, but it does not.
What needs to change in order to make this happen?
